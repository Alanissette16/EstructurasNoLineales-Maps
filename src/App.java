...
public class App {
    ...
    private static void runEmpleadoExample() {
        EmpleadoContoller empleCtrl = new EmpleadoContoller();
        empleCtrl.addEmpleado(new Empleado(1, "Maria", "Maestra"));
        empleCtrl.addEmpleado(new Empleado(2, "Pedro", "Policia"));
        empleCtrl.addEmpleado(new Empleado(3, "Joel", "Doctor"));
